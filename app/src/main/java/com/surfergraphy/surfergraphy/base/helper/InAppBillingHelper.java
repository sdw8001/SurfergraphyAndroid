...
import com.surfergraphy.surfergraphy.base.util.IabHelper;
...
//        mItemService = new ItemService(activity);
    ...
    public InAppBillingHelper(Activity activity) {
        mPublicKey = "";
        init(activity);
    }
    // 공개키가 있는 생성자.
    ...
    // 실제 구매 (인앱결제)
    public void purchaseItem(final String sku, final PurchaseFinishedListener listener) {
...
//                        }
//                        CommonHelper.showMessageOK(mActivity, result.getResponse() + "");
...
//                    FullScreenProgressBar.hide();
                ...
                CommonHelper.showMessageOK(mActivity, "Success!~");
                // 통신이 성공하면 실제 소진을 시킨다.
